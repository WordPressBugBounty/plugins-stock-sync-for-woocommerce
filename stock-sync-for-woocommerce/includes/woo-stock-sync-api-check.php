...
class Woo_Stock_Sync_Api_Check {
	...
	public function check_credentials() {
		// Check that API credentials do not exist on this site
		// since it's a common misconception
		if ( $this->check_own_api_keys() ) {
			$this->errors[] = __( 'API key entered belongs to this site. Please enter the key for the other site.', 'woo-stock-sync' );
			return;
		}
	 ...
	 * Check own API keys
	 */
	public function check_own_api_keys() {
		global $wpdb;
